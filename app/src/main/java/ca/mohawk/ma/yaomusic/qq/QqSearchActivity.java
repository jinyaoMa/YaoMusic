...
public class QqSearchActivity extends AppCompatActivity implements TabLayout.OnTabSelectedListener, SearchView.OnQueryTextListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qq_search);
        ...
        mSectionsPagerAdapter = new QqSearchActivity.SectionsPagerAdapter(getSupportFragmentManager());
    ...
    public void search(int tabId, String keyword) {
        ...
        QqSearchActivity.PlaceholderFragment placeholderFragment = (QqSearchActivity.PlaceholderFragment) this.mSectionsPagerAdapter
        ...
        if (qqSearchTask != null) {
            qqSearchTask.cancel(true);
        }
        qqSearchTask = new QqSearchTask(this);
        qqSearchTask.execute(tabId, keyword);
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            rootView = inflater.inflate(R.layout.fragment_qq_search, container, false);
            return rootView;
        }
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    switch (getArguments().getInt(ARG_SECTION_NUMBER)) {
                        ...
                        case 2:
                            ...
                            intent.putExtra("reference", R.id.nav_qq);
            ...
            listView.setOnScrollListener(new AbsListView.OnScrollListener() {
                ...
                public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                    if ((firstVisibleItem + visibleItemCount) == totalItemCount && loadMoreFlag && totalItemCount >= LIMIT) {
                        ...
                        QqSearchActivity qqSearchActivity = (QqSearchActivity) getActivity();
                        QqSearchTask qqSearchTask = new QqSearchTask(qqSearchActivity);
                        qqSearchTask.execute(qqSearchActivity.tabLayout.getSelectedTabPosition(), qqSearchActivity.searchView.getQuery().toString(), ++nextPage);
