...
public class WangyiSearchActivity extends AppCompatActivity implements TabLayout.OnTabSelectedListener, SearchView.OnQueryTextListener, AdapterView.OnItemClickListener {
    ...
    WangyiSearchTask wangyiSearchTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wangyi_search);
        ...
        mSectionsPagerAdapter = new WangyiSearchActivity.SectionsPagerAdapter(getSupportFragmentManager());
    ...
    public void search(int tabId, String keyword) {
        ...
        WangyiSearchActivity.PlaceholderFragment placeholderFragment = (WangyiSearchActivity.PlaceholderFragment) this.mSectionsPagerAdapter
        ...
        if (wangyiSearchTask != null) {
            wangyiSearchTask.cancel(true);
        }
        wangyiSearchTask = new WangyiSearchTask(this);
        wangyiSearchTask.execute(tabId, keyword);
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            rootView = inflater.inflate(R.layout.fragment_wangyi_search, container, false);
            return rootView;
        }
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    switch (getArguments().getInt(ARG_SECTION_NUMBER)) {
                        ...
                        case 2:
                            ...
                            intent.putExtra("reference", R.id.nav_wangyi);
            ...
            listView.setOnScrollListener(new AbsListView.OnScrollListener() {
                ...
                public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                    if ((firstVisibleItem + visibleItemCount) == totalItemCount && loadMoreFlag && totalItemCount >= LIMIT) {
                        ...
                        WangyiSearchActivity wangyiSearchActivity = (WangyiSearchActivity) getActivity();
                        WangyiSearchTask wangyiSearchTask = new WangyiSearchTask(wangyiSearchActivity);
                        wangyiSearchTask.execute(wangyiSearchActivity.tabLayout.getSelectedTabPosition(), wangyiSearchActivity.searchView.getQuery().toString(), ++nextPage);
