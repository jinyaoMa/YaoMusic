...
import ca.mohawk.ma.yaomusic.SonglistActivity;
import ca.mohawk.ma.yaomusic.util.SearchListAdapter;
import ca.mohawk.ma.yaomusic.database.SearchHistoryDatabaseHelper;

public class QianqianSearchActivity extends AppCompatActivity implements TabLayout.OnTabSelectedListener, SearchView.OnQueryTextListener, AdapterView.OnItemClickListener {
    ...
    QianqianSearchTask qianqianSearchTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qianqian_search);
        ...
        mSectionsPagerAdapter = new QianqianSearchActivity.SectionsPagerAdapter(getSupportFragmentManager());
    ...
    public void search(int tabId, String keyword) {
        ...
        QianqianSearchActivity.PlaceholderFragment placeholderFragment = (QianqianSearchActivity.PlaceholderFragment) this.mSectionsPagerAdapter
        ...
        if (qianqianSearchTask != null) {
            qianqianSearchTask.cancel(true);
        }
        qianqianSearchTask = new QianqianSearchTask(this);
        qianqianSearchTask.execute(tabId, keyword);
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            rootView = inflater.inflate(R.layout.fragment_qianqian_search, container, false);
            return rootView;
        }
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    switch (getArguments().getInt(ARG_SECTION_NUMBER)) {
                        ...
                        case 2:
                            ...
                            intent.putExtra("reference", R.id.nav_qianqian);
            ...
            listView.setOnScrollListener(new AbsListView.OnScrollListener() {
                ...
                public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                    if ((firstVisibleItem + visibleItemCount) == totalItemCount && loadMoreFlag && totalItemCount >= LIMIT) {
                        ...
                        QianqianSearchActivity qianqianSearchActivity = (QianqianSearchActivity) getActivity();
                        QianqianSearchTask qianqianSearchTask = new QianqianSearchTask(qianqianSearchActivity);
                        qianqianSearchTask.execute(qianqianSearchActivity.tabLayout.getSelectedTabPosition(), qianqianSearchActivity.searchView.getQuery().toString(), ++nextPage);
